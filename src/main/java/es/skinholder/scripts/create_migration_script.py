...
# Script SQL inicial
sql_script = "-- Borrar la base de datos si existe\n"
sql_script += "DROP DATABASE IF EXISTS SkinHolderDB;\n\n"
sql_script += "-- Crear la base de datos\n"
...
sql_script += "    CONSTRAINT fk_UserID FOREIGN KEY (UserID) REFERENCES Users(UserID)\n"
sql_script += ") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;\n\n"
...
sql_script += "    CONSTRAINT fk_RegistroID FOREIGN KEY (RegistroID) REFERENCES Registros(RegistroID)\n"
sql_script += ") CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;\n\n"
